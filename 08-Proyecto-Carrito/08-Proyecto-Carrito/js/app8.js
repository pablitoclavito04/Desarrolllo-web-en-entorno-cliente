...
function cargarEventListeners () {
    // ✨ NUEVO: Cargar carrito desde Local Storage cuando carga la página
    ...
    vaciarCarritoBtn.addEventListener('click', () => {
        ...
        sincronizarStorage()    // ✨ NUEVO: Sincronizamos con Local Storage
    })
}
...
function añadirCurso(e) {
 ...
 // ✨ NUEVA FUNCIÓN: Sincronizar el carrito con Local Storage
